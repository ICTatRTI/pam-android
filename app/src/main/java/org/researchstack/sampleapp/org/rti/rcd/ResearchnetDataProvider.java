...
import org.researchstack.sampleapp.bridge.BridgeDataArchive;
import org.researchstack.sampleapp.bridge.BridgeDataInput;
import org.researchstack.sampleapp.bridge.BridgeMessageResponse;
import org.researchstack.sampleapp.bridge.Info;
import org.researchstack.sampleapp.bridge.UploadQueue;
import org.researchstack.sampleapp.bridge.UploadRequest;
import org.researchstack.sampleapp.bridge.UploadSession;
import org.researchstack.sampleapp.bridge.UploadValidationStatus;
import org.researchstack.sampleapp.bridge.UserSessionInfo;
...
public abstract class ResearchnetDataProvider extends DataProvider
{
    ...
    private org.researchstack.sampleapp.bridge.BridgeDataProvider.BridgeService service;
    ...
    private void buildRetrofitService(UserSessionInfo userSessionInfo)
    {
        ...
        Retrofit retrofit = new Retrofit.Builder().addCallAdapterFactory(RxJavaCallAdapterFactory.create())
                ...
                .client(client)
                .build();
        service = retrofit.create(org.researchstack.sampleapp.bridge.BridgeDataProvider.BridgeService.class);
    }
