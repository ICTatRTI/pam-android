...
public class PermissionResultManager extends PermissionRequestManager
{
    ...
    {
        if (permissionId.equals(ResearchStackApplication.PERMISSION_NOTIFICATIONS))
        {
    ...
    {
        // ResearchStackApplication.PERMISSION_NOTIFICATIONS is our non-system permission so we return true
        // if permissionId's are the same
        return permissionId.equals(ResearchStackApplication.PERMISSION_NOTIFICATIONS);
    }
