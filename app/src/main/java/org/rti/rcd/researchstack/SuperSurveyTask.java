...
public class SuperSurveyTask extends SmartSurveyTask implements Serializable
{
     ...
     */
    public SuperSurveyTask(Context context, TaskModel taskModel)
    {
    ...
    private AnswerFormat from(Context context, TaskModel.ConstraintsModel constraints)
    {
        ...
        // need this for a quick way to provide my own answerformat
        else if (type.equals("PamImageConstraints")){
            AnswerFormat.ChoiceAnswerStyle answerStyle = constraints.allowMultiple
                    ? AnswerFormat.ChoiceAnswerStyle.MultipleChoice
                    : AnswerFormat.ChoiceAnswerStyle.SingleChoice;
            answerFormat = new PamAnswerFormat(answerStyle, from(constraints.enumeration));
        }
        else
        {
